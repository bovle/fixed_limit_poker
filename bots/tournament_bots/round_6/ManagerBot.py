...
class ManagerBotOld(BotInterface):

    # change the name of your bot here
    def __init__(self, name="ManagerBotOld"):
        '''init function'''
    ...
    def act(self, action_space:Sequence[Action], observation:Observation) -> Action: 
        ...
        if self.doIHaveAGoodHand or self.doIHaveAGoodHandAgainstTheTable:
            return Action.RAISE
    ...
    def doIHaveAGoodHandAgainstTheTable(self, observation:Observation):
        ...
        if observation.myHand[0] in handtype[1] and observation.myHand[1] in handtype[1]:
            return True
        return False
