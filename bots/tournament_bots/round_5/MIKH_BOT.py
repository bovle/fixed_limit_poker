...
class MIKH_Bot(BotInterface):
    ...
    def act(self, action_space:Sequence[Action], observation:Observation) -> Action:
        ...
        if stage == Stage.PREFLOP:
            ...
            return self.handleEnd(observation, action_space)
        '''
        stage = observation.stage
        if stage == Stage.PREFLOP:
        ...
        '''
    def handlePreFlop(self, observation: Observation, action_space) -> Action:
        ...
        # if my hand is top 60 percent: call
            ...
            return Action.CALL
        # else fold
        self.defaultAction(action_space)
    ...
    def handleEnd(self, observation: Observation, action_space) -> Action:
    ...
    def handlePostTurn(self, observation: Observation, action_space) -> Action:
        # get my hand's percent value (how good is this 2 card hand out of all possible 2 card hands)
        handPercent, _ = getHandPercent(observation.myHand)
        # if my hand is top 20 percent: raise
        if handPercent < .20:
