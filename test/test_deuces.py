...
class TestDeuces(TestCase):
    def testDeucesDoesNotCrash(self):
        # create a card
        card = Card.new('Qh')
        ...
        print(
            f"Player 1 hand rank = {p1_score} {evaluator.class_to_string(p1_class)}")
        print(
            f"Player 2 hand rank = {p2_score} {evaluator.class_to_string(p2_class)}")
